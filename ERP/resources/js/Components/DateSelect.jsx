...
// Constante movida para fora do componente para evitar re-alocação de memória em cada re-render
const options = [
  { id: 0, period: 'Today' },
...
export default function DateSelect() {
  ...
  // Fechar ao clicar fora (com ciclo de vida estabilizado)
  useEffect(() => {
      ...
      >
        ...
        >
          {options.map((option) => (
            ...
            >
              <svg
                className={`shrink-0 mr-2 fill-current text-blue-500 ${
